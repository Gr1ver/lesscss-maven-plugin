...
assert log.getText().contains("|   |-- import2"+File.separatorChar+"less1import2a.less");
assert log.getText().contains("|   |   `-- import2a"+File.separatorChar+"less1import2a1.less");
assert log.getText().contains("|   `-- import2"+File.separatorChar+"less1import2b.less");
